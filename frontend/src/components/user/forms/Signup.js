...
export default function SignUpForm() {
  return ( 
    <><div><img src={image3} style={{height:750, width:900 , float:'left'}} /></div>
    <Box
          component="form"
          sx={{
          ...
          autoComplete="off"
      >
          <div style={{fontWeight: 'bold' , fontSize: '30px', textAlignLast:'end'}}>Register</div>
        ...
        renderInput={(params) => (
          ...
          <div><Button variant="contained" onClick={SignUpFinal()}>Next</Button></div>
      </Box></>
  );
}
