...
const ViewFlightSummary = ({ input1, input2, handlePrice, nextPage }) => {
  ...
  const calculatePrice = () => {
    ...
    switch (input1.details.cabin) {
      case "economy":
        price =
          input2.flight.economy.adultPrice * adults +
          input2.flight.economy.childPrice * children +
          input1.flight.economy.adultPrice * adults +
          input1.flight.economy.childPrice * children;
        break;
      case "business":
        price =
          input2.flight.business.adultPrice * adults +
          input2.flight.business.childPrice * children +
          input1.flight.business.adultPrice * adults +
          input1.flight.business.childPrice * children;
        break;
      case "first":
        price =
          input2.flight.firstClass.adultPrice * adults +
          input2.flight.firstClass.childPrice * children +
          input1.flight.firstClass.adultPrice * adults +
          input1.flight.firstClass.childPrice * children;
        break;
    }
